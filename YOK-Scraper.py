...
path = "C:/Users/baris/Desktop/Akademik-YOK.csv"

path = '/media/DRIVE/Dropbox/_My_Research/Akademik-Yok-Paper/50.Scraper/Akademik-YOK.csv'
...
start = 0 #en son bitlis ünideydi(boğaziçi satırlarını sildim) boğaziçinden başlayacak, boğaziçi 45. indexte
